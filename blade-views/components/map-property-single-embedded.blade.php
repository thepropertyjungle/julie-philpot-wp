...
<div class="ratio ratio-16x9 property-map-embedded">
    <iframe loading="lazy" src="https://www.google.com/maps/embed/v1/place?key={{ blade_global_options('google_maps_api_key') }}&q={{ $lat ?? '51.5073509' }},{{ $lng ?? '-0.1277583' }}&zoom={{ $initial_zoom ?? '17' }}" allowfullscreen></iframe>
</div>