{{--
    ATTENTION
    =========
    /src/scss/partials/privacy-policy.scss
    ...
    Be aware that this file does include a link to the Privacy
    Policy page. You can create a global dynamic option for it
    named 'privacy_policy' and choose your page. Or you can leave
    it to fallback to the URL of /privacy-policy/.
--}}

<section id="tpj_privacy_policy">
    <p>We are <strong class="text-uppercase">{{ isset($global_options['gdpr_options']['registrationCompanyName']) && $global_options['gdpr_options']['registrationCompanyName'] !== '' ? $global_options['gdpr_options']['registrationCompanyName'] : 'COMPANY NAME NEEDED' }}
    </strong> with registered number <strong>{{ isset($global_options['gdpr_options']['registrationCompanyNumber']) && $global_options['gdpr_options']['registrationCompanyNumber'] !== '' ? $global_options['gdpr_options']['registrationCompanyNumber'] : 'COMPANY REGISTRATION NUMBER NEEDED' }}</strong> and address <strong>{{ isset($global_options['gdpr_options']['companyMailAddress']) && $global_options['gdpr_options']['companyMailAddress'] !== '' ? $global_options['gdpr_options']['companyMailAddress'] : 'COMPANY ADDRESS NEEDED' }}</strong>. Our Data Protection Lead can be contacted at <a href="mailto:{{ isset($global_options['gdpr_options']['companyEmailAddress']) && $global_options['gdpr_options']['companyEmailAddress'] !== '' ? $global_options['gdpr_options']['companyEmailAddress'] : 'EMAIL ADDRESS NEEDED' }}">{{ isset($global_options['gdpr_options']['companyEmailAddress']) && $global_options['gdpr_options']['companyEmailAddress'] !== '' ? $global_options['gdpr_options']['companyEmailAddress'] : 'EMAIL ADDRESS NEEDED' }}</a>. We have produced this privacy notice in order to keep you informed of how we handle your personal data. All handling of your personal data is done in compliance with the UK Data Protection Act 2018 and the General Data Protection Regulation (EU) 2016/679 ("Data Protection Legislation"). The terms "Personal Data", "Special Categories of Personal Data", "Personal Data Breach", "Data Protection Officer", "Data Controller", "Data Processor", "Data Subject" and "process" (in the context of usage of Personal Data) shall have the meanings given to them in the Data Protection Legislation. "Data Protection Lead" is the title given to the member of staff leading our data protection compliance programme in lieu of a requirement for a Data Protection Officer.</p>

    <h2>What are your rights?</h2>

    <p>When reading this notice, it might be helpful to understand that your rights arising under Data Protection Legislation include:</p>
    ...
    <ul>
        ...
        <li>The right to withdraw consent at any time, by emailing <a href="mailto:{{ isset($global_options['gdpr_options']['companyEmailAddress']) && $global_options['gdpr_options']['companyEmailAddress'] !== '' ? $global_options['gdpr_options']['companyEmailAddress'] : 'EMAIL ADDRESS NEEDED' }}">{{ isset($global_options['gdpr_options']['companyEmailAddress']) && $global_options['gdpr_options']['companyEmailAddress'] !== '' ? $global_options['gdpr_options']['companyEmailAddress'] : 'EMAIL ADDRESS NEEDED' }}</a>;</li>
    ...
    <p>You can exercise your right to access personal data held about you by contacting <a href="mailto:{{ isset($global_options['gdpr_options']['companyEmailAddress']) && $global_options['gdpr_options']['companyEmailAddress'] !== '' ? $global_options['gdpr_options']['companyEmailAddress'] : 'EMAIL ADDRESS NEEDED' }}">{{ isset($global_options['gdpr_options']['companyEmailAddress']) && $global_options['gdpr_options']['companyEmailAddress'] !== '' ? $global_options['gdpr_options']['companyEmailAddress'] : 'EMAIL ADDRESS NEEDED' }}</a> with the subject line: "Subject Access Request". When you submit a 'subject access request', you will need to provide confirmation of your identity by including a photocopy of your driver's license or passport. This service is provided free of charge and our response will be made within thirty (30) days, unless our Data Protection Lead deems your request as being excessive or unfounded. If this is the case, we will inform you of our reasonable administration costs in advance and/or any associated delays, giving you the opportunity to choose whether you would like to pursue your request. If you believe we have made a mistake in evaluating your request, please see the section 'Who can you complain to?'.</p>

    <p>If you have questions about any of the rights mentioned in this section, please contact our Data Protection Lead at <a href="mailto:{{ isset($global_options['gdpr_options']['companyEmailAddress']) && $global_options['gdpr_options']['companyEmailAddress'] !== '' ? $global_options['gdpr_options']['companyEmailAddress'] : 'EMAIL ADDRESS NEEDED' }}">{{ isset($global_options['gdpr_options']['companyEmailAddress']) && $global_options['gdpr_options']['companyEmailAddress'] !== '' ? $global_options['gdpr_options']['companyEmailAddress'] : 'EMAIL ADDRESS NEEDED' }}</a>.</p>
    ...
    <ul>
        ...
        <li>If we have purchased your personal data from a third-party for our own purposes, we are the Data Controller. Where we have purchased your personal data, we will contact you to let you know before we first start to use it, or, at the latest, within one month of acquiring it.</li>
        <li>If we have been passed your personal data from a third-party for our own purposes, we are the Data Controller. We will contact you to let you know before we first start to use it, or, at the latest, within one month of acquiring it.</li>
        <li>If we have been passed your personal data from a third-party for a joint purpose that we both influence, we are the joint Data Controller. We will contact you to let you know before we first start to use your data, or, at the latest, within one month of acquiring it.</li>
        <li>If your data has been passed to us by a third party for processing under their instruction, that third party is the Data Controller. They should have notified you that they would be passing your personal data to us, <strong class="text-uppercase">{{ isset($global_options['gdpr_options']['registrationCompanyName']) && $global_options['gdpr_options']['registrationCompanyName'] !== '' ? $global_options['gdpr_options']['registrationCompanyName'] : 'COMPANY NAME NEEDED' }}</strong>, at the time they collected your data and within their own privacy notices/standards. For a list of Data Controllers that we process personal data for, the section below 'Third Party Interests'.</li>
        <li>If we have received your personal data as part of a business to business relationship, the Data Controller is your employer.</li>
    </ul>

    <h2>What are the lawful bases for processing personal data?</h2>

    <p>Under Data Protection Legislation, there must be a 'lawful basis' for the use of personal data. The lawful bases are :</p>
    ...
    <div class="table-responsive">
        <table class="table table-bordered table-stripped">
            ...
            <tbody>
                ...
                @if($global_options['gdpr_options']['gdprOnlinePayments'])
                <tr>
                    <td>Online Payment Processing</td>
                    <td>
                        <ul>
                            <li>Identity Data</li>
                            <li>Contact Data</li>
                ...
                @endif
                @if($global_options['gdpr_options']['gdprDirectPayments'])
                <tr>
                    <td>Direct Debits</td>
                    <td>
                        <ul>
    ...
    <p>Cookies are small text files that are placed on your computer's hard drive through your web browser when you visit any web site. They are widely used to make web sites work, or work more efficiently, as well as to provide information to the owners of the site.</p>
    ...
    <h2>What happens if I refuse to give <span class="text-uppercase">{{ isset($global_options['gdpr_options']['registrationCompanyName']) && $global_options['gdpr_options']['registrationCompanyName'] !== '' ? $global_options['gdpr_options']['registrationCompanyName'] : 'COMPANY NAME NEEDED' }}
    </span> my personal data?</h2>
    ...
    <h2>What are <span class="text-uppercase">{{ isset($global_options['gdpr_options']['registrationCompanyName']) && $global_options['gdpr_options']['registrationCompanyName'] !== '' ? $global_options['gdpr_options']['registrationCompanyName'] : 'COMPANY NAME NEEDED' }}
    </span>'s 'legitimate interests'?</h2>

    <p>Legitimate interests are a flexible basis upon which the law permits the processing of an individual's personal data. To determine whether we have a legitimate interest in processing your data, we balance the needs and benefits to us against the risks and benefits for you of us processing your data. This balancing is performed as objectively as possible by our Data Protection Lead. You are able to object to our processing and we shall consider the extent to which this affects whether we have a legitimate interest. If you would like to find out more about our legitimate interests, please contact <a href="mailto:{{ isset($global_options['gdpr_options']['companyEmailAddress']) && $global_options['gdpr_options']['companyEmailAddress'] !== '' ? $global_options['gdpr_options']['companyEmailAddress'] : 'EMAIL ADDRESS NEEDED' }}">{{ isset($global_options['gdpr_options']['companyEmailAddress']) && $global_options['gdpr_options']['companyEmailAddress'] !== '' ? $global_options['gdpr_options']['companyEmailAddress'] : 'EMAIL ADDRESS NEEDED' }}</a>.</p>

    <h2>What profiling or automated decision making do we perform?</h2>

    <p><strong class="text-uppercase">{{ isset($global_options['gdpr_options']['registrationCompanyName']) && $global_options['gdpr_options']['registrationCompanyName'] !== '' ? $global_options['gdpr_options']['registrationCompanyName'] : 'COMPANY NAME NEEDED' }}
    </strong> does not perform any profiling or automated decision making based on your personal data.</p>

    <h2>How long will your personal data be kept?</h2>

    <p><strong class="text-uppercase">{{ isset($global_options['gdpr_options']['registrationCompanyName']) && $global_options['gdpr_options']['registrationCompanyName'] !== '' ? $global_options['gdpr_options']['registrationCompanyName'] : 'COMPANY NAME NEEDED' }}
    </strong> holds different categories of personal data for different periods of time. Wherever possible, we will endeavour to minimise the amount of personal data that we hold and the length of time for which it is held.</p>
    ...
    <p><strong class="text-uppercase">{{ isset($global_options['gdpr_options']['registrationCompanyName']) && $global_options['gdpr_options']['registrationCompanyName'] !== '' ? $global_options['gdpr_options']['registrationCompanyName'] : 'COMPANY NAME NEEDED' }}
    </strong> passes your data to the third parties listed in the section 'Third Party Interests' below, for the purposes of providing our services to you, and for no other purpose.</p>

    <h2>Does your data leave the EU?</h2>

    <p><strong class="text-uppercase">{{ isset($global_options['gdpr_options']['registrationCompanyName']) && $global_options['gdpr_options']['registrationCompanyName'] !== '' ? $global_options['gdpr_options']['registrationCompanyName'] : 'COMPANY NAME NEEDED' }}
    </strong> uses overseas web and IT providers. Details of what data is sent where, and the safeguards in place, are included in the section 'Third Party Processors' below.</p>
        ...
        <table class="table table-bordered table-stripped">
            <thead>
                <tr>
                    ...
                    <th><strong>If applicable - who is their representative within the EU?</strong></th>
                </tr>
            </thead>
            <tbody>
                <tr>
                    <td>HMRC, regulatory authorities or other authorities</td>
                    <td>We are joint Controller with these authorities who require reporting of processing in some situations</td>
                    <td>N/A</td>
                </tr>
                @if($global_options['gdpr_options']['gdprOnlinePayments'])
                <tr>
                    <td>Payment Processors</td>
                    <td>We are joint Controller with these service providers who simply pass payments you make through their services directly to us based on a transaction. These transactions are subject to the provider's privacy notices/policies.</td>
                    <td>N/A for European based services - please contact <a href="mailto:{{ isset($global_options['gdpr_options']['companyEmailAddress']) && $global_options['gdpr_options']['companyEmailAddress'] !== '' ? $global_options['gdpr_options']['companyEmailAddress'] : 'EMAIL ADDRESS NEEDED' }}">{{ isset($global_options['gdpr_options']['companyEmailAddress']) && $global_options['gdpr_options']['companyEmailAddress'] !== '' ? $global_options['gdpr_options']['companyEmailAddress'] : 'EMAIL ADDRESS NEEDED' }}</a> if you would like to find out about a specific representative.</td>
                </tr>
                @endif
                <tr>
                    <td>Postal/Courier Providers</td>
                    <td>Where these providers act as Data Controller, we are joint Controller with them for the purposes of sending you physical documents.</td>
                    <td>N/A</td>
                </tr>
            </tbody>
        </table>
    ...
    @if(!empty($global_options['gdpr_options']['data_processor_list']))
        <div class="table-responsive">
            <table class="table table-bordered table-striped">
                ...
                <tbody>
                    @foreach ($global_options['gdpr_options']['data_processor_list'] as $processor)
                        <tr>
                            <td>{{ $processor['processorName'] }}</td>
                            <td>{{ $processor['processorServiceDesc'] }}</td>
                        </tr>
                    @endforeach
                </tbody>
            </table>
    ...
    @else
        <p>NO DATA PROCESSORS HAVE BEEN ADDED</p>
    @endif

    <h2>Who can you complain to?</h2>

    <p>In addition to sending us your complaints directly to <a href="mailto:{{ isset($global_options['gdpr_options']['companyEmailAddress']) && $global_options['gdpr_options']['companyEmailAddress'] !== '' ? $global_options['gdpr_options']['companyEmailAddress'] : 'EMAIL ADDRESS NEEDED' }}">{{ isset($global_options['gdpr_options']['companyEmailAddress']) && $global_options['gdpr_options']['companyEmailAddress'] !== '' ? $global_options['gdpr_options']['companyEmailAddress'] : 'EMAIL ADDRESS NEEDED' }}</a>, you can send complaints to our supervisory authority. As <strong class="text-uppercase">{{ isset($global_options['gdpr_options']['registrationCompanyName']) && $global_options['gdpr_options']['registrationCompanyName'] !== '' ? $global_options['gdpr_options']['registrationCompanyName'] : 'COMPANY NAME NEEDED' }}
    </strong> predominantly handles the personal data of UK nationals, our supervisory authority is the Information Commissioner's Office. If you believe that we have failed in our compliance with data protection legislation, complaints to this authority can be made by visiting <a href="https://ico.org.uk/concerns" rel="nofollow noopener noreferrer" target="_blank">ico.org.uk</a>.</p>
</section>
