{{--
    ATTENTION
    =========
    This is an example search form that uses the Google Places API to find locations.
        ...
        <div class="card-body">
            <div class="row mb-3">
                ...
                <div class="col">
                    ...
                    >
                        <option value="sale" selected data-activate=".sales-prices">Buying or Renting?</option>
                        <option value="sale" data-activate=".sales-prices">Buying</option>
                ...
                <div class="col">
                    <select
                        ...
                        class="form-control"
                    >
                        <option value="" selected disabled>Choose radius</option>
