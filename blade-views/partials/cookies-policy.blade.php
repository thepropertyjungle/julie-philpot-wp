{{--
    ATTENTION
    =========
    /src/scss/partials/cookies-policy.scss
...
<section id="tpj_cookies_policy">
    ...
    <p>You can find more information about the individual cookies we use and the purposes for which we use them by contacting our Data Protection Lead at the contact address listed on our <a href="{{ isset($global_options['privacy_policy']['permalink']) && $global_options['privacy_policy']['permalink'] !== '' ? $global_options['privacy_policy']['permalink'] : '/privacy-policy/' }}" rel="noopener noreferrer" target="_blank">Privacy Policy page</a>.</p>
</section>
