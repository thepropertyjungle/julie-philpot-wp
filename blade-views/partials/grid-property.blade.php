...
<a href="{{ $property['permalink'] ?? ''}}" class="card h-100 property-grid{{ $property['featured'] ?? false ? ' property--featured' : '' }}" data-branch-name="{{ $property['branch']['name'] }}" data-branch-ID="{{ $property['branch']['meta']['branch_remote_id'] }}" data-property-remote-ID="{{ $property['tpj_remote_id'] }}" data-department="{{ $property['department'] }}" data-property-type="{{ $property['property_type'] }}">
